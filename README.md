...
[![specification: v0.7.0](https://img.shields.io/badge/specification-v0.7.0-8b5cf6)](rfcs/RFC-0001-familiar-contract.md)
...
1. Read [`rfcs/RFC-0001-familiar-contract.md`](rfcs/RFC-0001-familiar-contract.md) — the normative spec (v0.7.0)
...
# Validate the claimant directory for your v0.7.0 claim
node validators/validate.js ./your-directory

# Verify the bundled reference validator + fixtures for the same v0.7.0 claim
npm test
```
...
```
rfcs/RFC-0001-familiar-contract.md ← The Familiar Contract (normative, v0.7.0)
README.md                ← This file
