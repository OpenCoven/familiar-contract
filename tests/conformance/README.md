# Familiar Contract v0.5.0 Conformance Suite
...
A claim of v0.5.0 structural conformance = the claimant directory passes `node validators/validate.js <directory>` and this fixture suite passes under `npm test`.
