# Familiar Contract v0.4.1 Conformance Suite
...
A claim of v0.4.1 structural conformance = the claimant directory passes `node validators/validate.js <directory>` and this fixture suite passes under `npm test`.
